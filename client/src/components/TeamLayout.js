...
class TeamLayout extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="">
                <div className="d-flex justify-content-center" style={{backgroundColor: this.props.team.color, color: '#fff'}}>
                ...
                {players && <ul className="list-group">
                    ...
                    {players.allrounders && players.allrounders.map((p, i) => <PlayerCard key={`bt_${i}`} player={p} {...this.props} />)}
